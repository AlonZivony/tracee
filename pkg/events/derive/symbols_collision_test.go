	...
	return []struct {
	...
	}{
		{
			...
			loadingSO: loadingSharedObj{
				...
				exportedSymbols: map[string]sharedobjs.DynamicSymbol{"open": {}},
			},
			loadedSOs: []testSO{
				{
					so: loadingSharedObj{
			...
			loadedSOs: []testSO{
				{
					so: loadingSharedObj{
						...
						exportedSymbols: map[string]sharedobjs.DynamicSymbol{"write": {}},
					},
					expectedCollisions: []string{},
				},
			},
		},
		{
			...
			loadingSO: loadingSharedObj{
				ObjInfo:         sharedobjs.ObjInfo{Id: sharedobjs.ObjID{Inode: 1}, Path: "1.so"},
				exportedSymbols: map[string]sharedobjs.DynamicSymbol{"open": {}, "ioctl": {}},
			},
			loadedSOs: []testSO{
				{
					so: loadingSharedObj{
						...
						exportedSymbols: map[string]sharedobjs.DynamicSymbol{"open": {}, "write": {}},
					},
					expectedCollisions: []string{"open"},
				},
			},
			...
			loadedSOs: []testSO{
				...
				},
				{
					so: loadingSharedObj{
						...
						exportedSymbols: map[string]sharedobjs.DynamicSymbol{"ioctl": {}},
					},
					expectedCollisions: []string{},
				},
			},
